...
public class AutoDAO {
    ...
    public ArrayList<Auto> mostrarAutosFiltro(String tipo, String filtro) {
        ArrayList<Auto> lista = new ArrayList<>();
        String sql = "SELECT * FROM auto WHERE " + tipo + " LIKE '" + filtro + "%%'";
    ...
    public ArrayList<Auto> mostrarAutosNoAsignadosFiltro(boolean asignados, String tipo, String filtro) {
        ArrayList<Auto> lista = new ArrayList<>();
        String sql = "SELECT * FROM auto WHERE asignado = " + asignados + " AND " + tipo + " LIKE '"+filtro+"%%'";

...
public class IF_Instructor extends javax.swing.JInternalFrame {
    ...
    // Campos y controles
    campo_busqueda.setBackground(blanco);
    rb_NSS.setBackground(fondoControles);
    rb_nombre.setBackground(fondoControles);
    caja_senior.setBackground(blanco);

    txt_campoBusqueda.setBackground(fondo);
    txt_senior.setBackground(fondo);

    // Tabla
    tablaInstructoresVista.setBackground(blanco);
    tablaInstructoresVista.setForeground(java.awt.Color.BLACK);

    tablaInstructoresVista.getTableHeader().setBackground(azulEncabezado);
    tablaInstructoresVista.getTableHeader().setForeground(blanco);
    tablaInstructoresVista.getTableHeader().setFont(
